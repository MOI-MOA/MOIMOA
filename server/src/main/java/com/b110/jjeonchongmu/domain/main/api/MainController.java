...
//    public ResponseEntity<ApiResponse<List<ScheduleListDTO>>> getUncheckSchedules(@RequestHeader("Authorization") String token) {
//        String jwtToken = token.replace("Bearer ", "");
//        Long userId = Long.valueOf(jwtTokenProvider.getUserId(jwtToken));
...
//    public ResponseEntity<ApiResponse<List<ScheduleListDTO>>> getPersonalSchedules(@RequestHeader("Authorization") String token) {
//        String jwtToken = token.replace("Bearer ", "");
//        Long userId = Long.valueOf(jwtTokenProvider.getUserId(jwtToken));
...
//    public ResponseEntity<ApiResponse<MonthScheduleListDTO>> getMonthSchedules(
//            @RequestHeader("Authorization") String token,
//            @PathVariable int year,
//            @PathVariable int month) {
//        String jwtToken = token.replace("Bearer ", "");
//        Long userId = Long.valueOf(jwtTokenProvider.getUserId(jwtToken));
//        MonthScheduleListDTO response = mainService.getMonthSchedules(userId, year, month);
//        return ResponseEntity.ok(ApiResponse.success(response));
//    }
//
//    /**5.  해당 일 일정 조회 - GET /api/v1/main/schedule/{year}/{month}/{date}*/
//    @GetMapping("/schedule/{year}/{month}/{date}")
//    public ResponseEntity<ApiResponse<DayScheduleListDTO>> getDaySchedules(
//            @RequestHeader("Authorization") String token,
//            @PathVariable int year,
//            @PathVariable int month,
...
//        String jwtToken = token.replace("Bearer ", "");
//        Long userId = Long.valueOf(jwtTokenProvider.getUserId(jwtToken));
//        DayScheduleListDTO response = mainService.getDaySchedules(userId, year, month, date);
//        return ResponseEntity.ok(ApiResponse.success(response));
//    }
//
//    /**2. 오늘 일정 조회 - GET /api/v1/main/schedule/today*/
//    @GetMapping("/schedule/today")
//    public ResponseEntity<ApiResponse<List<ScheduleListDTO>>> getTodaySchedules(@RequestHeader("Authorization") String token) {
//        String jwtToken = token.replace("Bearer ", "");
//        Long userId = Long.valueOf(jwtTokenProvider.getUserId(jwtToken));
